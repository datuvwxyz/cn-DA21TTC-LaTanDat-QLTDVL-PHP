    ...
    <div class="jld-card">
        ...
        <div class="jld-card-footer">
            ...
            <div class="button-group">
                <form action="{{ route('admin_approve_post', ['post_id' => $post->post_id])}}" method="POST">
                    @csrf
                    <button type="submit" class="btn btn-outline-success">Duyệt</button>
                </form>
                <form action="{{ route('admin_rejecte_post', ['post_id' => $post->post_id])}}" method="POST"
                    onsubmit="return confirm('Bạn có chắc chắn muốn từ chối bài đăng này?')">
                    @csrf
...
<script>
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = "{{ route('admin_post_list') }}";
        }
    });
</script>
@endif
