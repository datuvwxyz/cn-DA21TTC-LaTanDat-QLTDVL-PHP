...
<head>
    ...
    <!-- Social Buttons CSS -->
    <link href="{{asset('backend/admin/vendor/bootstrap-social/bootstrap-social.css')}}" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="{{asset('backend/admin/vendor/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet" type="text/css">

    <!-- MetisMenu CSS -->
    <link href="{{asset('backend/admin/vendor/metisMenu/metisMenu.min.css')}}" rel="stylesheet">
</head>
